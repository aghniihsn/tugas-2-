        ...
        >
          <Form.Item
            ...
            rules={[
              ...
              {
                validator: (_, value) => (value && value.includes("A1@") ? Promise.resolve() : Promise.reject("kode harus ada  A1@")),
              },
            ]}
          >
            <Input />
          ...
          <Form.Item
            ...
            rules={[
              ...
              {
                validator: (_, value) => (value && isNaN(parseFloat(value)) ? Promise.reject("harus menggunakan angka") : Promise.resolve),
              },
            ]}
          >
            <Input />
